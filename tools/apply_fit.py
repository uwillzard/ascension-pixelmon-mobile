...
# ---------------------------------------------------------------------
# 13) v0.32 - RECOVERY controlado: volta ao runtime v0.25 e restaura
#     somente o default.json NATIVO do Amethyst no armazenamento.
# ---------------------------------------------------------------------
# Objetivo desta build: isolar o codigo 1 sem empilhar v0.26-v0.31.
# NÃO altera ExitActivity, JNI, AscensionBootstrap, MinecraftProfile,
# renderer, NeoForge ou fluxo de launch.

_asc32_async = root / "app_pojavlauncher/src/main/java/net/kdt/pojavlaunch/tasks/AsyncAssetManager.java"
if not _asc32_async.is_file():
    raise SystemExit("[Ascension v0.32] AsyncAssetManager.java não encontrado")

_asc32_java = _asc32_async.read_text(encoding="utf-8")
_asc32_old = """                // This is disgusting, but am lazy. We probably wont be getting any updates to
...
"""
_asc32_new = """                // Ascension v0.32 RECOVERY: força somente o controle NATIVO
                // que já vem no Amethyst desta base. Nenhum JSON externo é injetado.
                ...
                // assets/default.json permanece 100% ORIGINAL do Amethyst v0.25.
...
"""
if _asc32_old not in _asc32_java:
    raise SystemExit("[Ascension v0.32] bloco default.json original do AsyncAssetManager não encontrado")
_asc32_java = _asc32_java.replace(_asc32_old, _asc32_new, 1)
_asc32_async.write_text(_asc32_java, encoding="utf-8")

print("[Ascension v0.32] RECOVERY base v0.25 + controle NATIVO restaurado + sem v0.26-v0.31 OK")
